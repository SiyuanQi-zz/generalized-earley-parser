...
def parse_arguments():
    ...
    parser.add_argument('--log-root', default=os.path.join(paths.log_root, 'wnp/baseline/frame'), help='log files path')
    parser.add_argument('--resume', default=os.path.join(paths.tmp_root, 'checkpoints/wnp/baseline/frame'), help='path to latest checkpoint')
